...
public class BinanceWebSocketHandlerImpl extends AbstractWebSocketHandler implements BinanceWebSocketHandler {
    ...
    @PostConstruct
    public void init() {
        this.session = webSocketManager.createSession(Exchange.BINANCE, this);
    }
    ...
    public void subscribeToTicker(List<String> symbols, List<String> currencies) throws Exception {
        if (session != null && session.isOpen()) {
            ...
            log.info("Binance 구독 메시지 전송: {}", message);
        }
    }
